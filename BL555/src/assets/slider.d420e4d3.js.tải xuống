              ...
              [
                {
                  ...
                  value: function (t, e) {
                    return (
                      ...
                      h.isObject(t) &&
                        (h.isNumberLike(t.min) && (this.element.setAttribute("min", "" + t.min), (this.min = t.min)),
                        h.isNumberLike(t.max) && (this.element.setAttribute("max", "" + t.max), (this.max = t.max)),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    (this.handleSize = l.getDimension(this.handle, e)),
                      ...
                      this._updatePercentFromValue(),
                      !1 !== t && l.triggerEvent(this.element, "change", { origin: this.identifier });
                  },
                },
                {
                  ...
                  value: function () {
                    this.vertical &&
                      !r &&
                      (document.addEventListener("touchmove", a._touchMoveScrollHandler, { passive: !1 }), (r = !0));
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (isNaN(t)) console.warn("New position is NaN");
                      ...
                      s < 0 && (s = 0),
                        this.vertical
                          ? ((this.buffer.style.height = s + "%"), (this.buffer.style.bottom = 0.5 * n + "%"))
                          : ((this.buffer.style.width = s + "%"), (this.buffer.style.left = 0.5 * n + "%")),
