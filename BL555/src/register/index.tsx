...
export default function Register({ onClose, onSwitchToLogin }: RegisterProps) {
  ...
  const [captcha, setCaptcha] = useState("5436");
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-1000 animate-in fade-in duration-300">
      <div className="bg-white rounded-[30px] shadow-2xl w-full max-w-[818px] max-h-[90vh] overflow-hidden flex flex-col border border-[#9fdff6] animate-in zoom-in-95 duration-300">
        ...
        >
          {/* Style tag bổ sung cho trình duyệt Webkit (Chrome, Safari, Edge) */}
          <style
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Hơn 6 Ký Tự Bao Gồm Chữ Và Số"
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#337b9d]"
                >
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                type="tel"
                placeholder="SĐT Bắt Đầu Bằng 0"
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center bg-gray-50 rounded-full pr-2">
                  ...
                  <RefreshCw
                    className="w-5 h-5 text-[#337b9d] cursor-pointer hover:rotate-180 transition-transform duration-500"
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <button
              ...
              h-11 
              rounded-full 
              bg-[linear-gradient(102deg,#fff_3.74%,#cbf1ff_51.87%,#fff)]
              text-[#337b9d] 
              font-bold 
              transition-all 
              active:scale-95
            ...
            >
              <img
                src="data:image/png;base64,"
                className="w-5 h-5"
                alt="fb"
              />
              Facebook
